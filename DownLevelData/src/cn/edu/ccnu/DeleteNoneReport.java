...
public class DeleteNoneReport {
	...
	{
		String fromFile = "DATA/newdownload/1/uid-fid-fnickname-ffcount-ftcount.txt";
		String toFile1 = "DATA/newdownload/1/uid-fid-fnickname-ffcount-ftcount-comment-deletenone.txt";
		String toFile2 = "DATA/newdownload/1/commentwrong.txt";
		DeleteNoneReport dnr = new DeleteNoneReport();
		dnr.delete(fromFile, toFile1,toFile2);
//		FileUtil fu = new FileUtil();
//		fu.mergeFiles("DATA/newdownload/1/", "uid-fid-fnickname-ffcount-ftcount1", "uid-fid-fnickname-ffcount-ftcount", 19, ".txt");
	}
}
