...
public class DownLoadRetweet {
	...
	public void getReTweets() throws IOException, WeiboException
	{
		...
		String retweetIdsFile = "DATA/newdownload/1/retweet/uid-fid-fnickname-ffcount-ftcount-retweet-deletenone.txt";  //已获取微博id和tweetcount的文件路径
		FileUtil fu = new FileUtil();
		String[] tokens = {                            //七个应用的七个token循环调用
				"2.00DdJ8lB0FVbraa5584478bclhpwVC",
				"2.00DdJ8lBpRRC5E58e83fb6f40zVtss",
				"2.00DdJ8lB0xzLPB7f3683bfed0BQamL",
				"2.00DdJ8lBSiwMBE5df8314446xRfhGD",
				"2.00DdJ8lB0JbR_Sac079e63aevcFNlC",
				"2.00DdJ8lBTBYz6E6e64296bc6Bl6oPC",
				"2.00DdJ8lBQ_jEAE2e3522bcf3r2H_5E"
				}; 
		String path = "DATA/newdownload/1/retweet/uid-fid-fnickname-ffcount-ftcount-retweet-deletenone.txt";  //保存获取到的数据的文件前缀
		String format = ".txt";
		BufferedWriter bw;
		String[] words;
